        ...
        <div>
            <div>
                ...
                <div className="filter-bar">
                    <div className="filter-slot">
                        <label>Genre</label>
                        <select className="filter-dropdown" value={genre} onChange={handleGenreSearch}>
                    ...
                    <div className="filter-slot">
                        <label>Rating</label>
                        <select className="filter-dropdown" value={rating} onChange={handleRatingSearch}>
                            <option>All</option>
                            <option>Good</option>
                            <option>Ok</option>
                            <option>Bad</option>
            ...
            <div className="movies-grid">
                {filteredMovies.map(movie => (
                    <MovieCard movie={movie} key={movie.id} toogleWatchlist={toogleWatchlist}
